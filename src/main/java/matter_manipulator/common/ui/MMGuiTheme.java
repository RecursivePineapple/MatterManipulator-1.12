...
/// [MMWidgetThemes].
public class MMGuiTheme {

    private static final List<MMGuiTheme> THEMES = new ArrayList<>();
    ...
    private MMGuiTheme(String themeId) {
    ...
    public static void registerThemes() {
        ...
        MMGuiThemes.init();
        THEMES.forEach(MMGuiTheme::register);
    }
    ...
    public static class EventHandler {
        ...
        public void onReloadThemes(ReloadThemeEvent.Pre event) {
            THEMES.forEach(MMGuiTheme::buildJson);
        }
    }
    ...
    public static class Builder {
        ...
        private final MMGuiTheme theme;
         ...
         */
        public Builder parent(MMGuiTheme parent) {
         ...
         *
         * @param textType WidgetTheme ID in {@link MMWidgetThemes}
         ...
         *
         * @param textureThemeId Widget theme id. See {@link MMWidgetThemes}.
         * @param textureId      Texture id found at {@link MMTextureIds}.
         */
         ...
         *
         * @param textureThemeId Widget theme id. See {@link MMWidgetThemes}.
         * @param backgroundId   Texture id found at {@link MMTextureIds}.
         */
         ...
         * @param textureThemeId    Widget theme id. See {@link MMWidgetThemes}.
         * @param backgroundId      Texture id found at {@link MMTextureIds}.
         * @param hoverBackgroundId Texture id found at {@link MMTextureIds}.
         */
         ...
         *
         * @param textureThemeId Widget theme id. See {@link MMWidgetThemes}.
         * @param wholeTextureId Texture id found at {@link MMTextureIds}, having empty and full texture in one image.
         ...
         *
         * @param textureThemeId Widget theme id. See {@link MMWidgetThemes}.
         * @param emptyTextureId Texture id found at {@link MMTextureIds}, shown when progress is empty.
         * @param fullTextureId  Texture id found at {@link MMTextureIds}, shown when progress is full.
         * @param imageSize      Size of the image for the direction in which the progressbar fills up.
         */
